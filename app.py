...
# ==========================================
st.set_page_config(page_title="AI Diagnostic Analytics", layout="wide")
...
# ==========================================
    ...
    st.dataframe(camp_summary.style.format({'Revenue': 'Rs {:,.0f}', 'Profit': 'Rs {:,.0f}'}), use_container_width=True)
